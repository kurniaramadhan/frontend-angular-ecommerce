...
export class DropdownFormService {
  ...
  getStates(theCountryCode: string): Observable<State[]> {
    const searchStatesUrl = `${this._statesUrl}/search/findByCountryCode?countryCode=${theCountryCode}`;
    return this._httpClient.get<GetResponseStates>(searchStatesUrl).pipe(
